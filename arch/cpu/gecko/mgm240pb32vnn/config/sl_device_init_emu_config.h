...
#define SL_DEVICE_INIT_EMU_EM1_VSCALE emuVScaleEM01_LowPower
// <q SL_DEVICE_INIT_EMU_EM4_RETAIN_LFXO> Retain LFXO in EM4

#define SL_DEVICE_INIT_EMU_EM1_RETAIN_LFXO         0

// <q SL_DEVICE_INIT_EMU_EM4_RETAIN_LFRCO> Retain LFRCO in EM4
#define SL_DEVICE_INIT_EMU_EM1_RETAIN_LFRCO        0

// <q SL_DEVICE_INIT_EMU_EM1_RETAIN_ULFRCO> Retain ULFRCO in EM4S
#define SL_DEVICE_INIT_EMU_EM1_RETAIN_ULFRCO       0
